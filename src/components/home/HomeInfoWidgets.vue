<template>
  <div class="row home-info-widgets">
    <div class="col-md-6 col-xl-3">
      <vuestic-widget class="primary-widget">
        <div class="info-widget-inner">
          <div class="stats">
            ...
            <div class="stats-title">{{'home.elements' | translate}}</div>
          </div>
        </div>
      </vuestic-widget>
    </div>
      ...
      <vuestic-widget class="info-widget">
        <div class="info-widget-inner">
          <div class="stats">
            ...
            <div class="stats-title">{{'home.versions' | translate}}</div>
          </div>
        </div>
      </vuestic-widget>
    </div>
      ...
      <vuestic-widget class="info-widget brand-warning">
        <div class="info-widget-inner">
          <div class="stats">
            ...
            <div class="stats-title">{{'home.teamMembers' | translate}}</div>
          </div>
        </div>
      </vuestic-widget>
    </div>
